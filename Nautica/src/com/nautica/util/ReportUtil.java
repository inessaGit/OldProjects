...
String fileName;
	...
	public static void main(String[] arg) throws Exception {
	   ...
	   String fileName="test"+c.get(Calendar.DAY_OF_MONTH) + "-" + c.get(Calendar.HOUR_OF_DAY) +".zip";
...
File zipFile=new File(folder,fileName);//specify folder and specify file name 
